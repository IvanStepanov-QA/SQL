...
Пример:
Допустим, у нас есть таблицы Пользователи и Профили. Каждый пользователь может иметь только один профиль.
...
Пример:
Рассмотрим таблицы Авторы и Книги. Один автор может написать много книг, но каждая книга принадлежит только одному автору.
...
Пример:
Рассмотрим таблицы Студенты и Курсы. Один студент может посещать множество курсов, а один курс может включать множество студентов.
...
1	Математика
2	Физика
Чтобы реализовать связь многие ко многим, создается промежуточная таблица Записи:
